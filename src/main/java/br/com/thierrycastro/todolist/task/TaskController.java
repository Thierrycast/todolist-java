package br.com.thierrycastro.todolist.task;
...
import br.com.thierrycastro.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (taskModel.getStartAt().isAfter(taskModel.getEndAt())) {
            ...
            return ResponseEntity.status(400).body("A data de término deve ser maior que a data início.");
        }
